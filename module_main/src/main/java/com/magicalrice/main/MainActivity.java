...
import com.magicalrice.base_libs.bean.AndroidTestInfo;
import com.magicalrice.common.base.BaseActivity;
import com.magicalrice.common.router.RouterTable;
import com.magicalrice.common.widget.recyclerview.SectionParameters;
import com.magicalrice.common.widget.recyclerview.SectionedRecyclerViewAdapter;
import com.magicalrice.common.widget.recyclerview.StatelessSection;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private List<AndroidTestInfo> getCustomViewList() {
        ...
        list.add(new AndroidTestInfo("应用内拖动悬浮按钮","",RouterTable.ITEM_VIEW_DRAGFLOAT));
        list.add(new AndroidTestInfo("通知栏","",RouterTable.ITEM_VIEW_NOTIFICATION));
        list.add(new AndroidTestInfo("自定义键盘","",RouterTable.ITEM_VIEW_KEYBOARD));
        list.add(new AndroidTestInfo("自定义Recyclerview","",RouterTable.ITEM_VIEW_RECYCLERVIEW));
        list.add(new AndroidTestInfo("自定义ItemDecoration","",RouterTable.ITEM_VIEW_RECYCLERVIEW_ITEMDECORATION));
        return list;
    }
    ...
    private class ExpandableTestSection extends StatelessSection {
        ...
        public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
            ...
            headerViewHolder.imgArrow.setImageResource(isExpendable ? R.drawable.ic_expand_less_black_24dp : R.drawable.ic_expand_more_black_24dp);
