...
public class PrototypeMeizuCircularProgressBar extends View {
    ...
    private void initData(AttributeSet attrs) {
        ...
        mRoundC = a.getDimension(R.styleable.cv_meizu_circular_progress_bar_cvRoundAngle,ScreenUtils.dp2px(getContext(),30));
        ...
        mTextColor = a.getColor(R.styleable.cv_meizu_circular_progress_bar_cvTextColor,Color.WHITE);
        mProgressColor = a.getColor(R.styleable.cv_meizu_circular_progress_bar_cvProgressColor,Color.parseColor("#FF34A350"));
        mDefColor = a.getColor(R.styleable.cv_meizu_circular_progress_bar_cvDefColor,Color.WHITE);
        mPauseColor = a.getColor(R.styleable.cv_meizu_circular_progress_bar_cvPauseColor,Color.parseColor("#FF34A350"));
