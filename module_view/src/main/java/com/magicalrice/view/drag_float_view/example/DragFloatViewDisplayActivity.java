package com.magicalrice.view.drag_float_view.example;
...
import com.magicalrice.view.drag_float_view.view.MagicalFloatingDragView;

/**
 * Created by Adolph on 2018/1/29.
 */

@Route(path = RouterTable.ITEM_VIEW_DRAGFLOAT)
