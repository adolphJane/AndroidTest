...
public class IntentUtils {
    ...
    private IntentUtils() {
        throw new UnsupportedOperationException("IntentUtils can`t be initialized");
    }
    ...
    public static Intent getInstallAppIntent(final File file, final String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(ApplicationUtils.getApp(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String packageName) {
        return ApplicationUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    }
