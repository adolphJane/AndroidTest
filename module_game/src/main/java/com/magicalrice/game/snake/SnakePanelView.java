...
public class SnakePanelView extends View {
    private static final String TAG = "SmakePanelView";

    private List<List<GridSquare>> mGridSquare = new ArrayList<>();
    private List<GridPosition> mSnakePositions = new ArrayList<>();

    private GridPosition mSnakeHeader;              //蛇头位置
    private GridPosition mFoodPosition;             //食物位置
    private int mSnakeLength = 3;                   //蛇长度
