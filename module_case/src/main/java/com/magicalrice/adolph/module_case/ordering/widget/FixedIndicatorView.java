package com.magicalrice.adolph.module_case.ordering.widget;
...
import com.magicalrice.adolph.module_case.ordering.widget.slidebar.ScrollBar;
...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    private void drawSlideBar(Canvas canvas) {
        ...
        switch (this.scrollBar.getGravity()) {
            ...
            case BOTTOM_FLOAT:
            default:
                offsetY = (int) (getHeight() - scrollBar.getHeight(getHeight()) - ScreenUtils.dp2px(getContext(), SLIDE_VERTICLE_PADDING));
                break;
        }
        ...
        int width = (int) (scrollBar.getSlideView().getWidth() - ScreenUtils.dp2px(getContext(), PADDING));
